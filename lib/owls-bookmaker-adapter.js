...
/**
 * Narrow Owls Bookmaker.eu v2 adapter for Golf + Rugby only.
 *
 * Unified GET /api/v1/{sport}/odds does not support golf/rugby (404).
 * Bookmaker Source API:
 *   GET /api/v2/bookmaker/{sport}/leagues
 *   GET /api/v2/bookmaker/{sport}?league={leagueKey}
 *
 * Sport groups: golf, rugby (Bookmaker's own slugs).
 */
