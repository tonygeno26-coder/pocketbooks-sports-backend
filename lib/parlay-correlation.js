...
var UX = Object.freeze({
  ...
  CORRELATED_SGP_REQUIRED: 'Same-game correlation needs SGP pricing (not available). Place as separate bets or remove a leg.',
  UNSUPPORTED_CORRELATION: 'This same-event combination is not supported. Remove a leg or bet separately.',
  DEPENDENT_FUTURE: 'Futures / dependent outcomes cannot be combined in a parlay.',
  SGP_ENGINE_UNAVAILABLE: 'Same-game parlays require a correlation pricing engine (not wired).'
});
