...
- **SQL:** `schema_minimal.sql` + proposed settlement_payments / opening_balances / settle_payment_option_a_tx / bootstrap_settlement_opening_epoch / cancel_bet_tx isolation
